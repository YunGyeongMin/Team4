	  ...
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="myNavbar">
	      <ul class="nav navbar-nav">
	      	<li><a href="/">Home</a></li>
	      	<li><a href="/myList/${sessionScope.info.num}">${sessionScope.info.name}</a></li>
	...
	<div class="container text-center">    
	  <div class="row">
		...
		<div class="col-sm-3 well">
		  <div class="well">
	        <img id="myImage" src="${sessionScope.info.img}" class="img-circle cursor-pointer" height="65" width="65" alt="Avatar" data-toggle="modal" data-target="#modal">
	      </div>
	    </div>
	      ...
	      <div class="modal-body">
	        <form>
	        	<div class="form-group text-center">
	        		<img id="preview" src="${sessionScope.info.img}" alt="your image" class="img-circle cursor-pointer" height="65" width="65"/>
	        	</div>
	        </form>
	      </div>
	      <div class="modal-footer">
	        <button id="saveBtn" type="button" class="btn btn-primary btn-block font-default" data-dismiss="modal">적용</button>
	      </div>
	    </div>
